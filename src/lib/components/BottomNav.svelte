<script lang="ts">
	...
	const HIDDEN_ROUTES = ['/login', '/studia'];
	...
	const tabs = [
		...
		},
		{
			...
			label: 'Cartelle',
			exact: false,
			icon: `<path d="M20 6h-8l-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/>`,
		},
		{
			href: '/cronologia',
			label: 'Cronologia',
			exact: false,
			icon: `<path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 000-1.5h-3.75V6z" clip-rule="evenodd"/>`,
		},
		{
			href: '/impostazioni',
			label: 'Impostazioni',
